...
$insert = "INSERT INTO tickets (usuario,email,telefono,area,descripcion,url,agente,mesa,categoria,subcategoria,t_registro,estado) 
VALUES ('$usuario','$email','$telefono','$area[4]','$descripcion','$archivo','$agente','$mesa','$categoria','$subcategoria',NOW(),'$estado')";
